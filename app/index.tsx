...
import { CATEGORIES } from '../src/data/medicines';
import { CategoryId, Medicine } from '../src/data/types';
import { expiryStatus, useCabinet } from '../src/store/cabinet';
import { alpha, colors, radius, shadow, shelfTints, type } from '../src/theme';
